...
  render() {
    console.log('Pending');
    return (
            <View style={{marginTop:"10%",elevation: 10,marginRight:"2%",marginLeft:"2%",backgroundColor:"#FFFFFF",borderRadius: 10}}>
                  <View style={{flexDirection: 'row',width:"100%",marginTop:20}}>
                    ...
                    <View style={wallet.RightContainer}> 
                      ...
                      <TouchableOpacity onPress={()=>this.detailJob('Detail')}>
                        <View style={{flexDirection:'row',alignSelf: 'flex-end'}}>
                            <Image style={{marginTop:10,width:15,height:15}} source={rightarrow} />
                        </View>
                      </TouchableOpacity>
                    </View>
                  </View>
