          ...
          <View style={{ marginRight: "2%", marginLeft: "2%" }}>
            ...
            >
              <Image
                style={wallet.image}
                source={
                  this.state.image ? { uri: this.state.image } : image_upload
                }
              />
            ...
            >
              <View
                style={{ width: "38%", marginLeft: 5, flexDirection: "row" }}
              >
            ...
            >
              <View
                style={{ width: "50%", marginLeft: 5, flexDirection: "row" }}
              >
            ...
            <View style={wallet.line} />
            <View
              style={{ marginBottom: 10, width: "90%", flexDirection: "row" }}
            >
              <View
                style={{ width: "30%", marginLeft: "6%", flexDirection: "row" }}
              >
                <Text
                  style={{ fontSize: 14, marginTop: 10, fontWeight: "bold" }}
                >
                  {" "}
                  Description
                </Text>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  location as soon as possible and address the issue
                  accordingly. Your expertise and prompt response are greatly
                  appreciated.
                </Text>
              </View>
            </View>
