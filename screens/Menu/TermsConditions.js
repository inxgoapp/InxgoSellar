  ...
          <ScrollView keyboardDismissMode={'on-drag'} style={{height:'100%',backgroundColor:'white'}}>
                ...
                <Text style={[menu.static,{fontSize: 13}]}>
                  <Text style={{ fontSize: 15 }}>{`\u25CF`}</Text><Text style={{ marginLeft:10, }}>
                    You must be at least 13 years old to use INXGO or have appropriate legal consent.
                  </Text>
                  {'\n'}
                  <Text style={{ fontSize: 15 }}>{`\u25CF`}</Text><Text style={{ marginLeft:10, }}>
                  ...
                  {'\n'}
                  <Text style={{ fontSize: 15 }}>{`\u25CF`}</Text><Text style={{ marginLeft:10, }}>
                  Do not engage in any unlawful activities or misuse the app.
                  </Text>
                  {'\n'}
                  <Text style={{ fontSize: 15 }}>{`\u25CF`}</Text><Text style={{ marginLeft:10, }}>
                ...
                <Text style={[menu.static,{fontSize: 13}]}>
                  <Text style={{ fontSize: 15 }}>{`\u25CF`}</Text><Text style={{ marginLeft:10, }}>
                  Maintain the security of your INXGO account credentials.                  </Text>
                  {'\n'}
                  <Text style={{ fontSize: 15 }}>{`\u25CF`}</Text><Text style={{ marginLeft:10, }}>
                  Promptly report any unauthorized use or breach of your account to us.                  </Text>
                  {'\n'}
                  <Text style={{ fontSize: 15 }}>{`\u25CF`}</Text><Text style={{ marginLeft:10, }}>
                ...
                {'\n'}
                <Text style={{ fontSize: 15 }}>{`\u25CF`}</Text><Text style={{ marginLeft:10, }}>
                While we implement reasonable measures to protect your data, absolute security cannot be guaranteed.
                ...
                <Text style={[menu.static,{fontSize: 13}]}>
                  ...
                  {'\n'}
                  <Text style={{ fontSize: 15 }}>{`\u25CF`}</Text><Text style={{ marginLeft:10, }}>
                  Do not copy, modify, distribute, or reproduce any part of the app without our prior written consent.                  </Text>
                ...
                <Text style={[menu.static,{fontSize: 13}]}>
                  <Text style={{ fontSize: 15 }}>{`\u25CF`}</Text><Text style={{ marginLeft:10, }}>
                    INXGO provides job listings and facilitates connections, but we do not endorse or guarantee the accuracy, availability, or suitability of any job opportunities.
                  </Text>
                  {'\n'}
                  <Text style={{ fontSize: 15 }}>{`\u25CF`}</Text><Text style={{ marginLeft:10, }}>
