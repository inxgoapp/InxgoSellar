...
     return(
          <ScrollView keyboardDismissMode={'on-drag'} style={{height:'100%',backgroundColor:'white'}}>
                ...
                Welcome to the INXGO community! We're dedicated to creating a positive and inclusive space where professionals can connect, share insights, and support each other in their career journeys. To ensure everyone has a valuable and respectful experience, please adhere to the following guidelines:
                </Text>
                <Text style={[menu.static,{fontSize: 13,fontWeight:'bold',marginTop:10}]}>
                  1. Act with Respect and Professionalism:
                </Text>
