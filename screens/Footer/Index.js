      ...
      >
        <View style={appStyle.iconTextContainer}>
          <Image
            ...
            style={[
              appStyle.image,
              { tintColor: flag === "Home" ? "#FFC44D" : "black" },
            ]}
          />
          <Text
            style={[
      ...
      >
        <View style={appStyle.iconTextContainer}>
          <Image
            ...
            style={[
              appStyle.image,
              { tintColor: flag === "Booking" ? "#FFC44D" : "black" },
            ]}
          />
          <Text
            style={[
              appStyle.text,
              { color: flag === "Booking" ? "#FFC44D" : "black" },
            ]}
          >
            My Jobs
          </Text>
      ...
      >
        <View style={appStyle.iconTextContainer}>
          <Image
            ...
            style={[
              appStyle.image,
              { tintColor: flag === "Wallet" ? "#FFC44D" : "black" },
            ]}
          />
          <Text
            style={[
      ...
      >
        <View style={appStyle.iconTextContainer}>
          <Image
            ...
            style={[
              appStyle.image,
              { tintColor: flag === "Profile" ? "#FFC44D" : "black" },
            ]}
          />
          <Text
            style={[
